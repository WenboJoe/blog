...
@section('content')
	...
	<div class="menu_box">
		<ul>
			<li>
				...
				<ul class="sub_menu">
					<li><a href="{{url('admin/category')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>文章类别</a></li>
					<li><a href="{{url('admin/category/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加类别</a></li>
					...
					<li><a href="{{url('admin/about')}}" target="main"><i class="fa fa-fw fa-list-alt"></i>About Me</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://www.hbblog.com">http://www.hbblog.com</a>.
	</div>
@endsection
